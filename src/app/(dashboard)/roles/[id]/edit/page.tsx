...
export default function EditRolePage() {
  ...
  const [form, setForm] = useState<RoleFormData>({ name: "", description: "", is_active: true, permissionIds: [] });
  ...
  async function handleSave() {
    ...
    setSaving(true);
    try {
      const res = await roleService.update(roleId, {
        name: form.name.trim(),
      ...
      if (res.data.status === "success") {
        toast(res.data.message || "Role updated successfully", "success");
