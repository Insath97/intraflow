    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 xl:grid-cols-3">
        ...
        <div className="xl:col-span-1 space-y-6">
          ...
          {item.yesterday_summary && <Card className="overflow-hidden"><div className={sh}><div className="flex items-center gap-3"><div className="flex h-9 w-9 items-center justify-center rounded-lg bg-purple-100 text-purple-600"><Target className="h-4.5 w-4.5" /></div><div><h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">What I Did Yesterday</h3></div></div></div><CardContent className="p-6"><p className="text-sm text-gray-700 dark:text-gray-300 whitespace-pre-wrap">{item.yesterday_summary}</p></CardContent></Card>}
        </div>
      </div>
    </div>
  );
